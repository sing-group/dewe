...
public abstract class FileBasedSamplesEditor<T extends FileBasedSamples<E>, E extends FileBasedSample> extends JPanel {
	...
	class FileBasedSampleEditorComponent extends JPanel 
		implements FileBasedSampleEditorListener 
	{
		private static final long serialVersionUID = 1L;
		...
		public FileBasedSampleEditorComponent(FileBasedSampleEditor<E> editor) {
			this.editor = editor;
			this.editor.addFileBasedSampleEditorListener(this);
			this.init();
		}
	...
	private void sampleAdded() {
		for (FileBasedSamplesEditorListener l : getFileBasedSamplesEditorListeners()) {
	...
	public synchronized void addFileBasedSamplesEditorListener(FileBasedSamplesEditorListener l) {
		this.listenerList.add(FileBasedSamplesEditorListener.class, l);
	}

	public synchronized FileBasedSamplesEditorListener[] getFileBasedSamplesEditorListeners() {
		return this.listenerList.getListeners(FileBasedSamplesEditorListener.class);
	}
}