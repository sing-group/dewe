...
/**
 * An extension of {@code Bowtie2ReferenceGenomeIndexSelectionStep} that adds
 ...
 *
 */
public class AIBenchBowtie2ReferenceGenomeIndexSelectionStep
	extends Bowtie2ReferenceGenomeIndexSelectionStep {
	private CenteredJPanel stepComponent;

	/**
	 * Creates a new {@code AIBenchBowtie2ReferenceGenomeIndexSelectionStep}
	 * using {@code DefaultReferenceGenomeIndexDatabaseManager}.
	 */
	public AIBenchBowtie2ReferenceGenomeIndexSelectionStep() {
