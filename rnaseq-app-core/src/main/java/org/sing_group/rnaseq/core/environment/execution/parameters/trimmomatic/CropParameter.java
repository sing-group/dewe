...
public class CropParameter implements TrimmomaticParameter {
	private static final long serialVersionUID = 1L;

	public static final String DESCRIPTION = "Removes bases regardless of "
		+ "quality from the end of the read, so that the read has maximally "
		+ "the specified length after this step has been performed. Steps "
		+ "performed after CROP might of course further shorten the read.";
	public static final String DESCRIPTION_LENGTH = 
		"The number of bases to keep, from the start of the read.";

	private int length;

	public CropParameter(int length) {
		this.length = length;
	}
