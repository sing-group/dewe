...
/**
 * The interface that defines a FastQC binaries checker.
 * 
 * @author Hugo López-Fernández
 * @author Aitor Blanco-Míguez
 *
 */
public interface FastQcBinariesChecker
	extends BinariesChecker<FastQcBinaries> {
	/**
	 * Checks the fastqc command.
	 * 
