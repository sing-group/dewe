...
/**
 * The interface for controlling the PathfindR R package.
 *
 * @author Hugo López-Fernández
 * @author Aitor Blanco-Míguez
 *
 */
public interface PathfindRBallgownController {
	/**
	...
	/**
	 * <p>
	 * Performs the pathway enrichment analysis between of Ballgown DE results
	 * stored in {@code directory}.</p>
	 *
	 * @param input the directory that contains the Ballgown results
	 ...
	 * @param clusteringMethod the agglomeration method for pathway clustering
